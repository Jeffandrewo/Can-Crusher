...
$(document).ready(function(){
    ...
    database.ref('AdminKey').once('value', function(snapshot) {
        if (!snapshot.exists()) {
            database.ref('AdminKey').set('admin123'); // Default key
        }
    });
    ...
    $('#login-button').click(function() {
        ...
        database.ref('AdminKey').once('value', function(snapshot) {
            ...
            if (enteredKey === correctKey) {
                ...
                $('.back-button, .change-key-container').show();
                $('.error-message').hide();
            } else {
                $('.error-message').show();
            }
    ...
    $('.back-button').click(function() {
        ...
        $('.back-button, .change-key-container').hide();
        $('#admin-key').val('');
        $('.error-message').hide();
    });
    ...
    // Listen for crush count changes
    ...
    // Listen for plastic bottle count changes
    ...
    // Listen for aluminum can count changes
